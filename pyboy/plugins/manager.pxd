...
from pyboy.plugins.game_wrapper_links_awakening_dx cimport GameWrapperLinksAwakeningDX
# imports end
...
cdef class PluginManager:
    ...
    cdef public GameWrapperLinksAwakeningDX game_wrapper_links_awakening_dx
    ...
    cdef bint game_wrapper_links_awakening_dx_enabled
    # plugin_cdef end
